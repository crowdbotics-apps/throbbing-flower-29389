...
## Project Structure
    ...
    ├── throbbing_flower_29389  # Django project configurations
...
1. Clone this repo and `cd throbbing_flower_29389`
...
2. Clone this repo and `cd throbbing_flower_29389`
